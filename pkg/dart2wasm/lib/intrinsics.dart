  ...
  w.ValueType? generateStaticIntrinsic(StaticInvocation node) {
    ...
    if (node.target.enclosingLibrary.name == "dart.ffi") {
      ...
      if (loadStoreFunctionNames.hasMatch(name)) {
        ...
        final ffiPointerType = translator.translateType(InterfaceType(
            translator.ffiPointerClass, Nullability.nonNullable)) as w.RefType;
        final ffiPointerStruct = ffiPointerType.heapType as w.StructType;
        codeGen.wrap(
            pointerArg,
            translator.translateType(InterfaceType(
                translator.ffiPointerClass, Nullability.nonNullable)));
